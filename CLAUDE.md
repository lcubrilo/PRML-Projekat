...
| `neelagiriaditya`, `cadelueker`, `rajaisrarkiani` (Kaggle) | Same lineage, fresher (through 2025), less battle-tested. | varies | Verify schema + pre-fight aggregation yourself. |
